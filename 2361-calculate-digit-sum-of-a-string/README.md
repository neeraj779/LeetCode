<h2><a href="https://leetcode.com/problems/calculate-digit-sum-of-a-string/description/">2361. Calculate Digit Sum of a String</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code> consisting of digits and an integer <code>k</code>.</p>
